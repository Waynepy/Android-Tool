var deviceId = "51d7f55d-35f0-36e0-a811-0c5fe4a1aa06";
...
Java.perform(function() {
    var ClassC = Java.use("pc.c");

    ClassC.i.implementation = function(context) {
        console.log("DeviceID Alterado para:", deviceId);
